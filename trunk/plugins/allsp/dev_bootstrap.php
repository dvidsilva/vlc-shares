...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/AllSp.php',
);
...
$pluginsInstances = array(
	'allsp' => array(
		'class' => 'X_VlcShares_Plugins_AllSp',
		'configs' => array(
...
$dbInits = array(
	$basePath.'/install.sql' => (file_exists(APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_AllSp.en_GB.ini') == false),
);
