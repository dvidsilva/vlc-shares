 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/gorillavid.png' => APPLICATION_PATH.'/../public/images/icons/hosters/gorillavid.png',
	$basePath.'/languages/X_VlcShares_Plugins_GorillaVid.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_GorillaVid.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_GorillaVid.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_GorillaVid.it_IT.ini', // link al file di traduzione
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/GorillaVid.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/GorillaVid.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'gorillavid';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_GorillaVid';
