 ...
 */
$neededLinks = array(
	$basePath.'/public/images/tvlinks/' => APPLICATION_PATH.'/../public/images/tvlinks', // crea un link della cartella delle immagini
	$basePath.'/languages/X_VlcShares_Plugins_TvLinks.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_TvLinks.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_TvLinks.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_TvLinks.it_IT.ini', // link al file di traduzione
);
...
$includeFiles = array(
	...
	$basePath.'/library/X/PageParser/Parser/TvLinks.php' // <--- THIS IS AN EAMPLE FOR CONTROLLER INCLUSION
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/TvLinks.php', // <---- THIS IS AN EXAMPLE
);
 ...
 */
$pluginInstance_pluginKey = 'tvlinks';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_TvLinks';
