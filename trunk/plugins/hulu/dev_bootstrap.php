...
$neededLinks = array(
	...
	$basePath.'/public/images/hulu/logo.png' => APPLICATION_PATH.'/../public/images/hulu/logo.png',
	...
	$basePath.'/languages/X_VlcShares_Plugins_Hulu.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_Hulu.it_IT.ini', // link al file di traduzione
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Hulu.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hulu.php',
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/Hulu.php',
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'hulu';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_Hulu';
