...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/MyP2P.php', // <---- THIS IS AN EXAMPLE
);
 ...
 */
$pluginInstance_pluginKey = 'myp2p';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_MyP2P';
 ...
 */
$dbInits = array(
	$basePath.'/install.sql' => (file_exists(APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_MyP2P.en_GB.ini') == false),
);
