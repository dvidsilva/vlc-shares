 ...
 */
$neededLinks = array(
	$basePath.'/public/images/rtmpgui/' => APPLICATION_PATH.'/../public/images/rtmpgui', // crea un link della cartella delle immagini
	$basePath.'/languages/X_VlcShares_Plugins_RtmpGui.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_RtmpGui.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_RtmpGui.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_RtmpGui.it_IT.ini', // link al file di traduzione
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/RtmpGui.php', // <---- THIS IS AN EXAMPLE
);
 ...
 */
$pluginInstance_pluginKey = 'rtmpgui';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_RtmpGui';
