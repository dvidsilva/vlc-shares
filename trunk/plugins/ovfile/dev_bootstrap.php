 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/ovfile.png' => APPLICATION_PATH.'/../public/images/icons/hosters/ovfile.png',
	$basePath.'/languages/X_VlcShares_Plugins_OvFile.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_OvFile.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_OvFile.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_OvFile.it_IT.ini', // link al file di traduzione
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/OvFile.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/OvFile.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'ovfile';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_OvFile';
