 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/own3dlive.png' => APPLICATION_PATH.'/../public/images/icons/hosters/own3dlive.png',
...
$includeFiles = array(
	...
	$basePath.'/library/X/PageParser/Parser/Own3dLive.php', // <--- THIS IS AN EAMPLE FOR CONTROLLER INCLUSION
	$basePath.'/library/X/Streamer/Engine/RtmpDumpOwn3d.php',
	$basePath.'/library/X/RtmpDumpOwn3d.php'
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Own3d.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/Own3dLive.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'own3d';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_Own3d';
