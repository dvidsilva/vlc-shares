 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/putlocker.png' => APPLICATION_PATH.'/../public/images/icons/hosters/putlocker.png',
	$basePath.'/languages/X_VlcShares_Plugins_PutLocker.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_PutLocker.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_PutLocker.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_PutLocker.it_IT.ini', // link al file di traduzione
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/PutLocker.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/PutLocker.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'putlocker';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_PutLocker';
