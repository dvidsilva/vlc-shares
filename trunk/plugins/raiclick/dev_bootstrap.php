 ...
 */
$neededLinks = array(
	$basePath.'/public/images/raiclick/' => APPLICATION_PATH.'/../public/images/raiclick', // crea un link della cartella delle immagini
	$basePath.'/languages/X_VlcShares_Plugins_RaiClick.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_RaiClick.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_RaiClick.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_RaiClick.it_IT.ini', // link al file di traduzione
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/RaiClick.php', // <---- THIS IS AN EXAMPLE
);
 ...
 */
$pluginInstance_pluginKey = 'raiclick';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_RaiClick';
