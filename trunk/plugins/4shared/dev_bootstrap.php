 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/4shared.png' => APPLICATION_PATH.'/../public/images/icons/hosters/4shared.png',
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/4Shared.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/4Shared.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = '4shared';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_4Shared';
