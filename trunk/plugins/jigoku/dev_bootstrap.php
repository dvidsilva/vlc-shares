...
$neededLinks = array(
	...
	$basePath.'/languages/X_VlcShares_Plugins_Jigoku.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_Jigoku.en_GB.ini',
	$basePath.'/languages/X_VlcShares_Plugins_Jigoku.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_Jigoku.it_IT.ini',
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Jigoku.php',
);
...
$pluginsInstances = array(
	'jigoku' => array(
		'class' => 'X_VlcShares_Plugins_Jigoku',
		'configs' => array(
...
$dbInits = array(
	$basePath.'/install.sql' => (file_exists(APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_Jigoku.en_GB.ini') == false),
);
