...
class X_VlcShares_Plugins_Helper_Hoster_SockShare implements X_VlcShares_Plugins_Helper_HostInterface {

	const ID = 'sockshare';
	const PATTERN = '/http\:\/\/((www\.)?)sockshare\.com\/(file|embed)\/(?P<ID>[A-Za-z0-9]+)/';
	...
	function getHosterUrl($playableId) {
		return "http://www.sockshare.com/file/$playableId";
	}
