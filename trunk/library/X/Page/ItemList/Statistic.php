...
class X_Page_ItemList_Statistic extends X_Page_ItemList {
	 ...
	 */
	public function append(X_Page_Item_Statistic $item) {
		$this->items[] = $item;
		return $this;
	}
	 ...
	 * @return X_Page_ItemList_Statistic 
	 */
	public function replace($key, X_Page_Item_Statistic $item) {
		if ( $key instanceof X_Page_Item_Statistic) {
			$key = $key->getKey();
		} else {
			$key = (string) $key;
		}
	 ...
	 * @return X_Page_ItemList_Statistic
	 */
	public function merge(X_Page_ItemList_Statistic $list = null) {
