...
#     															#
########## Cache Plugin for VlcShares 0.5.1 and 0.5.2 ###########
...
Store fetched contents in cache memory for faster browsing. Is compatible with VLCShares 0.5.1 and 0.5.2 only
