 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/movshare.png' => APPLICATION_PATH.'/../public/images/icons/hosters/movshare.png',
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/MovShare.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/MovShare.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'movshare';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_MovShare';
