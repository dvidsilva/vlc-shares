...
class X_VlcShares_Plugins_4Shared extends X_VlcShares_Plugins_Abstract {
	...
	public function gen_beforeInit(Zend_Controller_Action $controller) {
		...
		$this->helpers()->hoster()->registerHoster(new X_VlcShares_Plugins_Helper_Hoster_4Shared());
