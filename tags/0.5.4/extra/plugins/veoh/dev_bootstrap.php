 ...
 */
$includeFiles = array(
	$basePath.'/application/controllers/VeohController.php' // <--- THIS IS AN EAMPLE FOR CONTROLLER INCLUSION
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Veoh.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/Veoh.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'veoh';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_Veoh';
