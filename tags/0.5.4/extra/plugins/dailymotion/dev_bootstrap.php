 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/dailymotion.png' => APPLICATION_PATH.'/../public/images/icons/hosters/dailymotion.png',
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/DailyMotion.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/DailyMotion.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'dailymotion';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_DailyMotion';
