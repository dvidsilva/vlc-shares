...
class X_VlcShares_Plugins_Helper_Hoster_RealDebridMegaporn extends X_VlcShares_Plugins_Helper_Hoster_RealDebridAbstract {
	
	const ID = 'megaporn-realdebrid';
	const PATTERN = '/http\:\/\/((www\.)?)megaporn\.com\/video\/\?v\=(?P<ID>[A-Za-z0-9]+)/';
