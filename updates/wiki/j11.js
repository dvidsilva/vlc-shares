...
var searchURL_tmpl = "http://code.google.com/p/%PROJECT%/issues/list?can=1&q=%SEARCH%";
...
function buildContent() {
    var B = "<td valign='top'><a href='http://code.google.com/p/%PROJECT%/issues/detail?id=%ID%' target='_blank'>%ID%</a>%CONTENT%</td>";
    var G = "<td valign='top' style='white-space: nowrap; border-top: 1px solid #BBBBBB;'>%CONTENT%</td>";
    var C = "<td valign='top'>%CONTENT%</td>";
    var I = "<td valign='top' style='border-top: 1px solid #BBBBBB;'><a href='http://code.google.com/p/%PROJECT%/issues/detail?id=%ID%' target='_blank'>%ID%</a>%CONTENT%</td>";
