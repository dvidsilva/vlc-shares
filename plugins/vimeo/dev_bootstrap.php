 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/vimeo.png' => APPLICATION_PATH.'/../public/images/icons/hosters/vimeo.png',
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Vimeo.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/Vimeo.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'vimeo';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_Vimeo';
