...
class X_VlcShares_Plugins_Helper_Hoster_RealDebridCwtv extends X_VlcShares_Plugins_Helper_Hoster_RealDebridAbstract {
	
	const ID = 'cwtv-realdebrid';
	const PATTERN = '/http\:\/\/(www\.)?cwtv\.com\/cw-video\/(?P<ID>[^\?]+)/';
