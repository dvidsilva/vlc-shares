...
class X_VlcShares_Plugins_Helper_Hoster_RealDebridCbs extends X_VlcShares_Plugins_Helper_Hoster_RealDebridAbstract {
	
	const ID = 'cbs-realdebrid';
	const PATTERN = '/http\:\/\/(www\.)?cbs\.com\/shows\/(?P<ID>.+)/';
