 ...
 */
$neededLinks = array(
	$basePath.'/public/images/youporn/' => APPLICATION_PATH.'/../public/images/youporn', // crea un link della cartella delle immagini
	$basePath.'/public/images/icons/hosters/youporn.png' => APPLICATION_PATH.'/../public/images/icons/hosters/youporn.png', // hoster link
	$basePath.'/languages/X_VlcShares_Plugins_YouPorn.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_YouPorn.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_YouPorn.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_YouPorn.it_IT.ini', // link al file di traduzione
);
...
$includeFiles = array(
	...
	$basePath.'/library/X/PageParser/Parser/YouPorn.php', // <--- THIS IS AN EAMPLE FOR CONTROLLER INCLUSION
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/YouPorn.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/YouPorn.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'youporn';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_YouPorn';
