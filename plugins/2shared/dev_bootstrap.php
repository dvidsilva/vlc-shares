 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/2shared.png' => APPLICATION_PATH.'/../public/images/icons/hosters/2shared.png', // hoster link
	$basePath.'/languages/X_VlcShares_Plugins_2Shared.en_GB.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_2Shared.en_GB.ini', // link al file di traduzione
	$basePath.'/languages/X_VlcShares_Plugins_2Shared.it_IT.ini' => APPLICATION_PATH.'/../languages/X_VlcShares_Plugins_2Shared.it_IT.ini', // link al file di traduzione
);
...
$includeFiles = array(
	...
	$basePath.'/library/X/PageParser/Parser/2Shared.php', // <--- THIS IS AN EAMPLE FOR CONTROLLER INCLUSION
);
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/2Shared.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/2Shared.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = '2shared';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_2Shared';
