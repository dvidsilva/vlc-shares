 ...
 */
$neededLinks = array(
	$basePath.'/public/images/icons/hosters/videobb.png' => APPLICATION_PATH.'/../public/images/icons/hosters/videobb.png',
...
$pluginsIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/VideoBB.php', // <---- THIS IS AN EXAMPLE
);
...
$helpersIncludes = array(
	$basePath.'/library/X/VlcShares/Plugins/Helper/Hoster/VideoBB.php', // <---- THIS IS AN EXAMPLE
);

/**
 * Insert here the pluginKey
 */
$pluginInstance_pluginKey = 'videobb';

/**
 * Insert here the plugin class
 */
$pluginInstance_pluginClass = 'X_VlcShares_Plugins_VideoBB';
